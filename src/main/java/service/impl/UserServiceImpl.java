...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public org.apache.catalina.User registerUser(UserDTO userDTO) {
        User user = new User();
        user.setFullName(userDTO.getFullName());
        user.setEmail(userDTO.getEmail());
        user.setPassword(userDTO.getPassword());
...
//    Reset Password
    ...
    @Override
    public org.apache.catalina.User getByResetPasswordToken(String token) {
    ...
    @Override
    public org.apache.catalina.User findByEmail(String email) {
    ...
    @Override
    public Page<model.User> pageFindAll(int pageNumber, String sortField, String sortDir) {
