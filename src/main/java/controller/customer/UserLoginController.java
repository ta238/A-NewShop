...
public class UserLoginController {
    ...
    public String processingRegistration(@Valid @ModelAttribute("userDTO") UserDTO userDTO,
        ...
        if (userDTO.getPassword().equals(userDTO.getConfirmPassword())) {
            ...
            String verifyURL = Utility.getSiteURL(request) + "/shop/verify?code=" + user.getUserDatabase();

            userService.sendVerificationEmail((model.User) user, verifyURL);
    ...
    public String processResetPassword(HttpServletRequest request, Model model) {
        ...
        if (password.equals(newPassword)) {
            ...
            if (user == null) {
                ...
                userService.updatePassword((model.User) user, password);
