...
public class UserSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain2(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .requestMatchers("/shop/register","/shop/forgotPassword","/shop/processingRegistration",
                ...
                .requestMatchers("/shop/cart/**","/shop/checkout","/shop/processingCheckOut").hasAuthority("USER")
                .and()
                .formLogin()
